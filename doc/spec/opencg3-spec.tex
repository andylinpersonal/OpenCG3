...
\newcommand{\Version}[0]{Version 0.3.0}
...
\begin{frame}[t] \frametitle{Properties of a Camera}
	...
	\begin{tabularx}{\textwidth}{|l|l|l|R|}
		...
		BG-Color   & background-rgb* & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{0 0 0}} \\ \hline
		Axis       & axis-enable*    & $\underline{\MSS\in\{\texttt{true},\texttt{false}\}}$ & \texttt{true} \\ \hline
		\multirow{3}{*}{Axis-Color}
		           & axis-x-rgb*     & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{255 0 0}} \\ \cline{2-4}
		           & axis-y-rgb*     & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{0 255 0}} \\ \cline{2-4}
		           & axis-z-rgb*     & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{0 0 255}} \\ \hline
		...
		Grid-Color & grid-rgb*       & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{191 191 191}} \\ \hline
...
\begin{frame}[t] \frametitle{Properties of a Point}
	...
	\begin{tabularx}{\textwidth}{|l|l|l|R|}
		...
		\multirow{4}{*}{In-Color}
		         & fill-rgb*     & $\Tup{\underline{\MSN\leqslant 255}}{3}$ & \texttt{\TupText{0 0 0}} \\ \cline{2-4}
		         & fill-rgba     & $\LstFull{\Tup{\underline{\MSN\in[0,255]}}{3} \ \ \underline{\MSR\in[0,1]}}$ & \texttt{\LstText{\TupText{31 0 63} 0.5}} \\ \cline{2-4}
		         & fill-hsv      & $\LstFull{\underline{\MSR\in[0,360)} \ \ \Tup{\underline{\MSR\in[0,1]}}{2}}$ & \texttt{\LstText{240 \TupText{0.8 1.0}}} \\ \cline{2-4}
		         & fill-hsl      & $\LstFull{\underline{\MSR\in[0,360)} \ \ \Tup{\underline{\MSR\in[0,1]}}{2}}$ & \texttt{\LstText{240 \TupText{1.0 0.6}}} \\ \hline
		...
		\multirow{2}{*}{Ex-Color}
		         & border-rgb*   & same as fill-rgb  & \texttt{\TupText{127 127 127}} \\ \cline{2-4}
...
\begin{frame}[t] \frametitle{Create Attributes}
	...
	\begin{block}{Examples}
		\CommandEx{create attrib \TupText{magenta dashed-and-translucent-line} \EOLText
		                         \LstText{\LstText{point fill-hsv \QuoteText{\LstText{300 \TupText{1.0 1.0}}}} \EOLText
