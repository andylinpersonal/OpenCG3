...
\newcommand{\Version}[0]{Version 0.2.3}
...
\begin{frame}[t] \frametitle{Create a Window}
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{title} the unique name of the window
...
\begin{frame}[t] \frametitle{Create Attributes}
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			...
			\InstrName{create attrib} &
				\ParamMust{\Tup{\StrName{palette}}{n}} &
				\ParamMust{\Lst{\LstFull{\StrName{type} \ \StrName{key} \ \ArgName{value}}}{\,\geqslant n}} & \InstrItem
		\end{tabularx}
	\end{block}

	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{palette} the name of the attribute
...
\begin{frame}[t] \frametitle{Attach Attributes}
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{attach attrib} &
				...
				\ParamMust{\SetOptl{\StrName{label}}{}} & \InstrItem \\
			\InstrName{attach attrib} &
				\ParamMust{\TupName{\StrName{palette}}{n}{}} &
				\ParamMust{\TupName{\StrName{label}}{n}{}} & \InstrItem
		\end{tabularx}
	\end{block}

	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{palette} the name of the attribute
		\ParamItem{label} the name of the object
	\end{itemize} \end{block}
	...
	\begin{block}{Examples}
		...
		\CommandEx{attach attrib \TupText{5px black} \SetText{point-3 circ-1}}
		\CommandEx{attach attrib \TupText{red thick} \TupText{point-4 line-0}}
	\end{block}
