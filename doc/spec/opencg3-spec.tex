	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{create attrib} &
				...
				\ParamMust{\LstOptl{\LstFull{\StrName{\Class{t}} \ \LstOptl{\StrName{prop} \ \StrName{value}}{}}}{}} & \InstrItem \\
			\InstrName{create attrib} &
				\ParamMust{\Tup{\StrName{attrib}}{}} &
				\ParamMust{\Lst{\LstFull{\StrName{\Class{t}} \ \LstOptl{\StrName{prop} \ \StrName{value}}{}}}{}} & \InstrItem
		\end{tabularx}
	\end{block}
