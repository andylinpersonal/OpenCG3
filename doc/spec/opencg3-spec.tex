...
\newcommand{\Version}[0]{Version 0.3.3}
...
\begin{frame}[t] \frametitle{Properties of a Window}
	...
	\begin{tabularx}{\textwidth}{|l|l|R|}
		...
		background-rgb & $\Tup{\Param{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 0 0}} \\ \hline
	\end{tabularx}
...
\begin{frame}[t] \frametitle{Properties of a Camera}
	...
	\begin{tabularx}{\textwidth}{|l|l|R|}
		...
		axis-xyz-rgb  & $\Tup{\Tup{\Param{\MSN\in[0,255]}}{3}}{3}$ & \texttt{\TupText{\TupText{255 0 0}\TupText{0 255 0}\TupText{0 0 255}}} \\ \hline
		...
		grid-xyz-rgb  & $\Tup{\Tup{\Param{\MSN\in[0,255]}}{3}}{3}$ & \texttt{\TupText{\TupText{127 0 0}\TupText{0 127 0}\TupText{0 0 127}}} \\ \hline
...
\begin{frame}[t] \frametitle{Properties of a Point}
	...
	\begin{tabularx}{\textwidth}{|l|l|R|}
        ...
        fill-rgb     & $\Tup{\Param{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{255 255 255}} \\ \hline
        \hline
        ...
        border-rgb   & $\Tup{\Param{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{127 127 127}} \\ \hline
	\end{tabularx}
...
\begin{frame}[t] \frametitle{Properties of a Line}
	...
	\begin{tabularx}{\textwidth}{|l|l|R|}
        ...
        fill-rgb & $\Tup{\Param{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{191 191 191}} \\ \hline
...
\begin{frame}[t] \frametitle{Create Attributes}
	...
	\begin{block}{Examples}
		\CommandEx{create attrib \TupText{magenta dashed-and-translucent-line} \EOLText
		                       ...
		                       \ \LstText{line \LstText{style dashed} \LstText{fill-rgb \QuoteText{\TupText{0 255 0}}} \LstText{pattern \QuoteText{\LstText{\TupText{16 8} px}}}}}}
	\end{block}
