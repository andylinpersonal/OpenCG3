...
\newcommand{\Version}[0]{Version 0.2.5}
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{create attrib} &
				\ParamMust{\SetOptl{\StrName{palette}}{}} &
				\ParamMust{\LstOptl{\LstFull{\StrName{type} \ \StrName{key} \ \ArgName{value}}}{}} & \InstrItem \\
			\InstrName{create attrib} &
				\ParamMust{\Tup{\StrName{palette}}{}} &
				\ParamMust{\Lst{\LstFull{\StrName{type} \ \StrName{key} \ \ArgName{value}}}{}} & \InstrItem
		\end{tabularx}
	\end{block}

	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{palette} the object name of the class attrib
		\ParamItem{type} the name of the class in the top class category
		\ParamItem{key} the property of the object of class \Param{type}
...
\begin{frame}[t] \frametitle{Attach Attributes}
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{attach attrib} &
				\ParamMust{\TupOptl{\StrName{palette}}{}} &
				\ParamMust{\SetOptl{\StrName{label}}{}} & \InstrItem \\
			\InstrName{attach attrib} &
				\ParamMust{\Tup{\StrName{palette}}{}} &
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{palette} the object name of the class attrib
		\ParamItem{label} the name of the object derived from the top class category
	\end{itemize} \end{block}
...
\begin{frame}[t] \frametitle{Assign an Operation Name}
	...
	\begin{block}{Parametres} \begin{itemize}
		...
		\ParamItem{type} the object of the class \Param{type} applying the action
