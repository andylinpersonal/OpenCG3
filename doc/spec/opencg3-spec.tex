...
\newcommand{\Version}[0]{Version 0.2.7}
...
\begin{frame}[t] \frametitle{Class and Object System}
	...
	\begin{block}{Classes}
		\begin{itemize}
			...
			\item Data classes are split into primitive class and compound classes.
...
\begin{frame}[t] \frametitle{Create a Window}
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{\Label{w}} the object name of the class window
...
\begin{frame}[t] \frametitle{Create a Camera}
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{\Label{c}} the object name of the class camera
		\ParamItem{centre}    the coordinate $(c_x, c_y, c_z)$ of the centre of the viewport
		\ParamItem{plane}     the horizontal and the vertical vertors $(\vec{v_w}, \vec{v_h})$ of the viewport
		\ParamItem{sight}     the reverse line of sight $\vec{v_c}$, which is from \Param{centre} to the camera
	\end{itemize} \end{block}
...
\begin{frame}[t] \frametitle{Create Points}
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{\Label{p}} the object name of the class point
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{create attrib} &
				\ParamMust{\SetOptl{\StrName{\Desc{a}}}{}} &
				\ParamMust{\LstOptl{\LstFull{\StrName{\Class{t}} \ \StrName{property} \ \ArgName{value}}}{}} & \InstrItem \\
			\InstrName{create attrib} &
				\ParamMust{\Tup{\StrName{\Desc{a}}}{}} &
				\ParamMust{\Lst{\LstFull{\StrName{\Class{t}} \ \StrName{property} \ \ArgName{value}}}{}} & \InstrItem
		\end{tabularx}
	\end{block}

	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{\Desc{a}}  the object name of the class attrib
		\ParamItem{\Class{t}} the name of one of the top classes
		\ParamItem{property}  the property of the object of the class
		\ParamItem{value}     the appropriate value of the property
	\end{itemize} \end{block}
	...
	\begin{block}{Command} \newcolumntype{R}{>{\raggedleft\arraybackslash}X}
		\begin{tabularx}{\textwidth}{@{}l@{}l@{}l@{}R}
			\InstrName{attach attrib} &
				\ParamMust{\TupOptl{\StrName{\Desc{a}}}{}} &
				\ParamMust{\SetOptl{\StrName{\Label{t}}}{}} & \InstrItem \\
			\InstrName{attach attrib} &
				\ParamMust{\Tup{\StrName{\Desc{a}}}{}} &
				\ParamMust{\Tup{\StrName{\Label{t}}}{}} & \InstrItem
		\end{tabularx}
	\end{block}

	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{\Desc{a}}  the object name of the class attrib
		\ParamItem{\Label{t}} the name of the object instantiated from the top classes
	\end{itemize} \end{block}
