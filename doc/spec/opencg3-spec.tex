...
\newcommand{\Version}[0]{Version 0.2.8}
...
\begin{frame}[t] \frametitle{Attach Attributes}
	...
	\begin{block}{Parametres} \begin{itemize}
		\ParamItem{attrib}    the object name of the class attrib
		\ParamItem{label}     the name of the object instantiated from the top classes
	\end{itemize} \end{block}
