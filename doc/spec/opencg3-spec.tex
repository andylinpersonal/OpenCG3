...
\begin{frame}[t] \frametitle{Properties of a Window}
	...
	\begin{tabularx}{\textwidth}{|l|l|l|R|}
		...
		BG-Color   & background-rgb* & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 0 0}} \\ \hline
	\end{tabularx}
...
\begin{frame}[t] \frametitle{Properties of a Camera}
	...
	\begin{tabularx}{\textwidth}{|l|l|l|R|}
		...
		\multirow{3}{*}{Axis-Color}
		           & axis-x-rgb*     & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{255 0 0}} \\ \cline{2-4}
		           & axis-y-rgb*     & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 255 0}} \\ \cline{2-4}
		           & axis-z-rgb*     & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 0 255}} \\ \hline
		...
		Grid-Color & grid-rgb*       & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{191 191 191}} \\ \hline
...
\begin{frame}[t] \frametitle{Properties of a Point}
	...
	\begin{tabularx}{\textwidth}{|l|l|l|R|}
		...
		\multirow{4}{*}{In-Color}
		         & fill-rgb*     & $\Tup{\underline{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 0 0}} \\ \cline{2-4}
