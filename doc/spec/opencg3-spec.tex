...
\newcommand{\Version}[0]{Version 0.3.2}
...
\begin{frame}[t] \frametitle{Properties of a Point}
	...
	\begin{tabularx}{\textwidth}{|l|l|R|}
        ...
        fill-rgb     & $\Tup{\Param{\MSN\in[0,255]}}{3}$ & \texttt{\TupText{0 0 0}} \\ \hline
        \hline
        ...
        border-rgb   & same as fill-rgb  & \texttt{\TupText{127 127 127}} \\ \hline
	\end{tabularx}
